...
const Card3 = (props) => {
    ...
    const dayS = props.days.join(',')
    const timeS = props.time.join(',')
  ...
  return (
    <div style={{background:"white",width:"100%",padding:"24px",display:"flex",justifyContent:"space-between",maxWidth:"1000px",marginBottom:"10px",borderRadius:"10px"}}>
      ...
      <div style={{fontWeight:'200',fontSize:".8em"}}>{props.email}</div>
      </div>
      <div style={{display:"flex",gap:"10px",alignItems:"center"}}>
        <div>
      
      
      <div style={{fontWeight:'200',textAlign:"center",fontSize:".8em",display:"flex",gap:"4px",color:"gray",justifyContent:"center"}}>{props.days.map(e=>{
